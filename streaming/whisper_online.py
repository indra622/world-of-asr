...
class ASRBase:
    ...
    def __init__(self, lang, modelsize=None, cache_dir=None, model_dir=None):
...
#        model = WhisperModel(modelsize, device="cpu", compute_type="int8") #, download_root="faster-disk-cache-dir/")
    ...
    #def transcribe(self, audio, init_prompt="Ready."):
    def transcribe(self, audio, init_prompt=""):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lang', '--language', type=str, default='en', help="Language code for transcription, e.g. en,de,cs.")
